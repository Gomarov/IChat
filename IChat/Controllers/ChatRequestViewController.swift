...
//  IChat
//
//  Created by  Pavel on 28.02.2021.
//
...
class ChatRequestViewController: UIViewController {
    ...
    let nameLabel = UILabel(text: "Ekaterina Gavrilova", font: .systemFont(ofSize: 20, weight: .light))
...
struct ChatRequestViewControllerProvider: PreviewProvider {
    ...
    struct ContainerView: UIViewControllerRepresentable {
        ...
        func updateUIViewController(_ uiViewController: UIViewControllerType, context: UIViewControllerRepresentableContext<ChatRequestViewControllerProvider.ContainerView>) {
